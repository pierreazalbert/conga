...
(function (w, d, u) {
    ...
    var linguLoader = function () {
        ...
        var cssCode = "a.lingumania_target { display: none; background-color: #f0eee9; } #lingumania_custom_id { display: block; color: #000; display: block; width: 70px; padding: 10px !important; text-decoration: none; } a.lingumania_target:hover { background-color: #f0eee9; } #lingumania_langswitcher{ position: absolute; top: 0px; right: 10px; text-transform: uppercase; text-align: left; text-indent: 15px; color: #000; font-size: 0.8rem;} #lingumania_langswitcher:hover a, #lingumania_langswitcher:focus a { display: block; position: relative; float: right; width: 70px; padding: 10px; clear: both; color: #000; text-decoration: none; } a#lingumania_currentlanglink { display: block; width: 70px; padding: 10px; background: url('/assets/caret-down.svg') no-repeat left center; background-size: 0.75rem; color: #000; font-weight: bold; text-decoration: none; } a#lingumania_currentlanglink:hover { background: url('/assets/caret-down-fill.svg') no-repeat left center; background-size: 0.75rem;} .lingumania_poweredby { display: none !important; }";
